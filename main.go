...
func main() {
	...
	client.AddEventHandler(func(evt interface{}) {
		...
		case *events.Message:
			...
			if !v.Info.IsFromMe {
				...
				} else if strings.HasPrefix(msgText, "genimg") {
					prompt := strings.TrimSpace(strings.TrimPrefix(msgText, "genimg"))
	...
	// Webhook Server
	http.HandleFunc("/webhook/image", service.HandleWebhook)
	go func() {
